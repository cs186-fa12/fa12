...
cost_agg(Path *path, PlannerInfo *root,
		 ...
		 int numGroupCols, double numOutputGroups,
		 ...
		 double input_tuples)
{
	...
	else if (aggstrategy == AGG_SORTED)
	{
		...
		total_cost += cpu_operator_cost * numOutputGroups * numAggs;
		total_cost += cpu_tuple_cost * numOutputGroups;
	}
	else
	{
		/* must be AGG_HASHED or AGG_HASHED_APPROX */
		startup_cost = input_total_cost;
