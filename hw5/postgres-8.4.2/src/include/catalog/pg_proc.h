...
/* NB186: Transition and final functions for the approximate-count aggregate */

DATA(insert OID = 5000 (  approx_count_inc PGNSP PGUID 12 1 0 0 f f f t f v 3 0 20 "20 23 23" _null_ _null_ _null_ _null_ approx_count_inc - _null_ _null_ ));
DATA(insert OID = 5001 (  approx_count_final PGNSP PGUID 12 1 0 0 f f f t f v 1 0 20 "20" _null_ _null_ _null_ _null_ approx_count_final - _null_ _null_ ));

/* NB186: The dummy function that defines the approximate-count aggregate itself */
DATA(insert OID = 5002 (  approx_count PGNSP PGUID 12 1 0 0 t f f f f v 3 0 20 "23 23 23" _null_ _null_ _null_ _null_ aggregate_dummy - _null_ _null_ ));
#define APPROX_COUNT_AGG_OID 5002
