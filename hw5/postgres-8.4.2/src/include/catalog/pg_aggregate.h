...
/*
 * NB186: This system catalog row defines the new approximate count
 * aggregate. Among other things, it specifies that the aggregate should be
 * implementing using the given transition and final functions. Note that
 * the OID of the aggregate is the same as the OID of the dummy aggregate
 * function we added to pg_proc.
 */
DATA(insert ( 5002	approx_count_inc	approx_count_final		0	20		"0" ));
