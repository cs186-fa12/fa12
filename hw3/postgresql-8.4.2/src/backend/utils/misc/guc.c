...
static const struct config_enum_entry buffer_policy_options[] = {
	{"clock", POLICY_CLOCK, false},
	{"lru", POLICY_LRU, false},
	{"mru", POLICY_MRU, false},
	{"2q", POLICY_2Q, false}
};
...
static struct config_enum ConfigureNamesEnum[] =
{
	...
	{
		{"buffer_replacement_policy", PGC_POSTMASTER, RESOURCES_MEM,
			gettext_noop("Sets the buffer pool replacement policy."),
			NULL
		},
		&BufferReplacementPolicy,
		POLICY_CLOCK, buffer_policy_options, NULL, NULL
	},
